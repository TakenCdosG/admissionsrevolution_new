 ...
 */
?>
<div class="login profile margin-top-20" id="theme-my-login<?php $template->the_instance(); ?>">
    ...
    <form id="your-profile" action="<?php $template->the_action_url('profile'); ?>" method="post">
        ...
        <h3><?php _e('MY INFO'); ?></h3>
        <table class="form-table">
            <tr>
                <th><label style="margin: -25px auto auto; display: block;" for="user_login"><?php _e('Username'); ?></label></th>
        ...
        <h3 class="hide"><?php _e('Contact Info'); ?></h3>
        ...
        <table class="form-table">
            ...
            <tr class="hide">
                ...
                <td><input type="hidden" name="url" id="url" value="<?php echo esc_attr($profileuser->user_url); ?>" class="regular-text code" /></td>
            </tr>
                ...
                <tr id="password">
                    ...
                    <td><input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /> <span class="description"><?php _e('If you would like to change the password type a new one. Otherwise leave this blank.'); ?></span><br />
                        ...
                        <input type="password" name="pass2" id="pass2" size="16" value="" autocomplete="off" /> <span class="description"><?php _e('Type your new password again.'); ?></span><br />
                          <div id="pass-strength-result hide"><?php _e('Strength indicator', 'theme-my-login'); ?></div>
                         <p class="description indicator-hint"><?php _e('Hint: The password should be at least seven characters long. To make it stronger, use upper and lower case letters, numbers and symbols like ! " ? $ % ^ &amp; ).'); ?></p>
                        -->
                    </td>
                </tr>
                <tr id="password_confirm">
                    <th><label for="pass1"><?php _e('Confirm Password'); ?></label></th>
                    <td><input type="password" name="pass2" id="pass2" size="16" value="" autocomplete="off" /> <span class="description"><?php _e('Type your new password again.'); ?></span><br />
                        <!--
                         <div id="pass-strength-result hide"><?php _e('Strength indicator', 'theme-my-login'); ?></div>
                         <p class="description indicator-hint"><?php _e('Hint: The password should be at least seven characters long. To make it stronger, use upper and lower case letters, numbers and symbols like ! " ? $ % ^ &amp; ).'); ?></p>
                        -->
        ...
        <br/>
        <br/>
        <h3 style="display:none"><?php _e('About Yourself'); ?></h3>
