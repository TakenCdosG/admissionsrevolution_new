    ...
    <div class="home_first_box">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="td-content-right" style="background-image:url(<?php echo $right_image_second_box; ?>); background-repeat: no-repeat; background-position: left top; background-size: cover;">
