    ...
    <?php } else { ?>
        ...
        <form id="pmpro_form" class="pmpro_form" action="<?php echo pmpro_url("billing", "", "https") ?>" method="post">
                        ...
                        <tr>
                            <td>
                                <div>
                                    ...
                                    <input id="bfirstname" name="bfirstname" type="text" class="<?php echo $bfirstname_class; ?> input" size="20" value="<?php echo esc_attr($bfirstname); ?>" /> 
                                    <?php echo $bfirstname_label; ?> 
                                </div>	
                                <div>
                                    <label for="blastname"><?php _e('Last Name', 'pmpro'); ?> *</label>
                                    <input id="blastname" name="blastname" type="text" class="   <?php echo $blastname_class; ?>  input" size="20" value="<?php echo esc_attr($blastname); ?>" /> 
                                    <?php echo $blastname_label; ?> 
                                </div>					
                                <div>
                                    <label for="baddress1"><?php _e('Address 1', 'pmpro'); ?> *</label>
                                    <input id="baddress1" name="baddress1" type="text" class="<?php echo $baddress1_class; ?> input" size="20" value="<?php echo esc_attr($baddress1); ?>" /> 
                                    <?php echo $baddress1_label; ?> 
                                </div>
                                <div>
                                    <label for="baddress2"><?php _e('Address 2', 'pmpro'); ?></label>
                                    <input id="baddress2" name="baddress2" type="text" class="input" size="20" value="<?php echo esc_attr($baddress2); ?>" /> <small style="  margin-left: 198px;" class="lite">(<?php _e('optional', 'pmpro'); ?>)</small>
                                </div>
                                ...
                                if ($longform_address) {
                                    ...
                                    <div>
                                        ...
                                        <input id="bcity" name="bcity" type="text" class="<?php echo $bcity_class; ?> input" size="30" value="<?php echo esc_attr($bcity) ?>" /> <br/>
                                    ...
                                    <div>
                                        ...
                                        <input id="bzipcode" name="bzipcode" type="text" class="<?php echo $bzipcode_class; ?> input" size="30" value="<?php echo esc_attr($bzipcode) ?>" /> 
                                    ...
                                    ?>
                                    <div>
                                        <label for="bcity_state_zip"><?php _e('City', 'pmpro'); ?> *</label>
                                        <input id="bcity" name="bcity" type="text" class="<?php echo $bcity_class; ?> input" size="14" value="<?php echo esc_attr($bcity) ?>" />
                                        <?php echo $bcity_label; ?><br/>                               
                                        <?php
                                        ...
                                        if ($state_dropdowns === true || $state_dropdowns == "names") {
                                            ...
                                            ?>
                                            <label for="bcity_state_zip"><?php _e('State', 'pmpro'); ?> *</label>
                                            <select name="bstate">
                                                <option value="">--</option>
                                                <?php
                                            ...
                                            ?>	
                                            <label for="bcity_state_zip"><?php _e('State', 'pmpro'); ?></label>
                                            <input id="bstate" name="bstate" type="text" class="input" size="2" value="<?php echo esc_attr($bstate) ?>" /> <br/>
                                            <?php
                                        }
                                        ?>		
                                        <label for="bcity_state_zip"><?php _e('Zip', 'pmpro'); ?></label>
                    ...
                    <tr valign="top">		
                        <td>	
                            ...
                            <div>
                                ...
                                </select><span style="margin-right: 10px;">/</span><select id="ExpirationYear" <?php if ($gateway != "stripe") { ?>name="ExpirationYear"<?php } ?>>
                                    <?php
                            ...
                            if ($pmpro_show_cvv) {
                                ...
                                <div>
                                    ...
                                    ?>" class="<?php echo $CVV_class; ?>  <?php echo pmpro_getClassForField("CVV"); ?>" <?php if ($gateway == "braintree") { ?>data-encrypted-name="cvv"<?php } ?> />  <small style="margin-left: 198px;">(<a href="javascript:void(0);" onclick="javascript:window.open('<?php echo pmpro_https_filter(PMPRO_URL) ?>/pages/popup-cvv.html', 'cvv', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=475');"><?php _ex("what's this?", 'link to CVV help', 'pmpro'); ?></a>)</small>
                                           <br/><?php echo $CVV_label; ?> 
                                </div>						
                                <?php
                            }
                            ?>
            ...
            <div align="center">
                ...
                <input type="submit" class="pmpro_btn pmpro_btn-submit alignleft" value="<?php _e('Update', 'pmpro'); ?>" />
