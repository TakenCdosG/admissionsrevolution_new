    ...
    <body <?php body_class("page-boxed page-header-fixed page-sidebar-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed"); ?>>
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner">
                ...
                <a href="javascript:;" class="menu-toggler responsive-toggler" data-toggle="collapse" data-target=".menu-dashboard-container">
                </a>
                    ...
                    <div class="page-actions col-sm-offset-2 col-md-offset-2">
                        ...
                        <div class="user_logged_in">
                            <ul id="login-singup-menu-top" class="login-singup-menu-top">
                                <li id="menu-item-120" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-120"><a class="user_login" href="<?php echo $site_url; ?>/all-videos/">Hello, <?php echo $current_user->user_login; ?></a></li>
                            </ul>
