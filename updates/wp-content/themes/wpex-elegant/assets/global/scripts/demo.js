    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            if (sidebarStyleOption === 'compact') {
                jQuery(".page-sidebar-menu").addClass("page-sidebar-menu-compact");
            } else {
                jQuery(".page-sidebar-menu").removeClass("page-sidebar-menu-compact");
            }
        ...
        jQuery('.layout-option, .page-header-top-dropdown-style-option, .page-header-option, .sidebar-option, .page-footer-option, .sidebar-pos-option, .sidebar-style-option, .sidebar-menu-option', panel).change(setLayout);
    };
    ...
    return {
        ...
        init: function() {
            ...
            if (jQuery.cookie && jQuery.cookie('layout-style-option') === 'rounded') {
                ...
                jQuery('.theme-panel .layout-style-option').val(jQuery.cookie('layout-style-option'));
            }            
        }
    };
