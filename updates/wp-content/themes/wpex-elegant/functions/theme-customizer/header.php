...
function wpex_customizer_general($wp_customize) {
    ...
    // logo Image collapse
    $wp_customize->add_setting('wpex_logo_collapse', array(
        'type' => 'theme_mod'
    ));

    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'wpex_logo_collapse', array(
        'label' => __('Image Logo Collapse', 'wpex'),
        'section' => 'wpex_header_section',
        'settings' => 'wpex_logo_collapse',
    )));
}
